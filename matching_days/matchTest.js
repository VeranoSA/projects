describe(' Matching Days function', function () {
    ...
    it('should return an array with days of the week and the status of the two days, match if they are the same, no match and alsoNomatch for non matching days ', function () {
